...
/**
 * Built on the JCU CP3406/CP5307 utility-app starter template. The template ships a single-Activity
 ...
 * routed through a [NavHost] so each section can drill down (Worlds → World → Character) while the
